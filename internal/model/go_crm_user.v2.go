...
type GoCrmUserV2 struct {
	...
	UsrStatus        bool   `gorm:"column:usr_status;not null;comment:Status 1:enable, O:disable, -1:deleted" json:"usr_status"` // Status 1:enable, O:disable, -1:deleted
}

// TableName GoCrmUser's table name
func (*GoCrmUser) TableNameV2() string {
