...
--
-- Current Database: `go-ec`
--

/*!40000 DROP DATABASE IF EXISTS `go-ec`*/;

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `go-ec` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
CREATE TABLE `go_crm_user` (
  ...
  `usr_status` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'Status 1:enable, O:disable, -1:deleted',
  PRIMARY KEY (`usr_id`),
...
CREATE TABLE `go_crm_user_v2` (
  ...
  `usr_status` tinyint(1) NOT NULL COMMENT 'Status 1:enable, O:disable, -1:deleted',
  PRIMARY KEY (`usr_id`)
...
CREATE TABLE `go_db_role` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT ' ''ID is PK''',
...
CREATE TABLE `go_db_user_roles` (
  ...
  `role_id` bigint NOT NULL COMMENT ' ''ID is PK''',
  PRIMARY KEY (`user_id`,`role_id`),
  KEY `fk_go_db_user_roles_role` (`role_id`),
  CONSTRAINT `fk_go_db_user_roles_role` FOREIGN KEY (`role_id`) REFERENCES `go_db_role` (`id`),
  CONSTRAINT `fk_go_db_user_roles_user` FOREIGN KEY (`user_id`) REFERENCES `go_db_user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-02-15  4:54:20
